...
public  abstract class ShipmentsStream {

    public static final String IN_TOPIC = KafkaShop.SHIPMENTS_TOPIC_INPUT;
    public static final String OUT_TOPIC = KafkaShop.SHIPMENTS_TOPIC_OUTPUT;
